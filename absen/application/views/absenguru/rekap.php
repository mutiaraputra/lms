            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        $bulan = $_GET['bulan'];
                        ?>
                        <a href="<?= base_url() ?>absenguru/exportabsen/?&bulan=<?= $bulan ?>&cariabsen=isset" class="btn btn-primary"> <i class="fas fa-file-export"></i> Download Rekapan</a>
                                        ...
                                        <?php foreach ($guru as $d) :  ?>
                                            ...
                                            <tr>
                                                ...
                                                if (isset($_GET['bulan'])) {
                                                    ...
                                                    $sql = "SELECT * FROM tabel_detail_absen_guru WHERE nik = '$nik' AND tanggal_absen LIKE '%$tahun-$cari_bulan_siswa%' ORDER BY tanggal_absen ASC";
                                                    $bulan = date('m');
                                                }
