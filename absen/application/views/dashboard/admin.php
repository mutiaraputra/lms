		...
		<div class="container-fluid">
			...
			<div class="col-xl-3 col-md-6">
				<div class="card bg-white mb-3">
					<div class="card-body">
						<h3 align="center"><span class="flaticon-381-alarm-clock"></span> Hari Ini</h3>
						<div id="date-and-clock mt-3">
							<h4 id="clocknow" align="center"></h4>
							<h5 id="datenow" align="center"></h5>
						</div>
						<div>
						<br>
						</div>
						...
						<div class="d-flex justify-content-center">
							<a href="<?= base_url('Kamera') ?>" class="btn-xl btn btn-primary">
								TAMPILKAN CAMERA <span>&#x1F4F7;</span>
							</a>
						</div>
						</div>
					</div>
