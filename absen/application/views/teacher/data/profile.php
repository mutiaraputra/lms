<div class="content-body">
    ...
    <div class="container-fluid">
        ...
        <?php if ($this->session->flashdata('flash')): ?>
            <div
                class="alert alert-<?= $this->session->flashdata('flash')['alert'] ?> alert-dismissible alert-alt fade show my-4 mx-5">
                <button type="button" class="close h-100" data-dismiss="alert" aria-label="Close"><span><i
                            class="mdi mdi-close"></i></span>
                </button>
                <strong><?= $this->session->flashdata('flash')['alert'] ?>!</strong>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="profile-blog mb-5">
                            ...
                            <img src="<?= base_url() . 'assets/images/user/' . $dataakun['gambar'] ?>" alt=""
                                class="img-fluid mt-4 mb-4 w-100">
                            <h4><a href="post-details.html"
                                    class="text-black text-center"><?= $dataakun['nama_siswa'] ?></a></h4>
                        </div>
                        ...
                        <div class="profile-tab">
                            <div class="custom-tab-1">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item"><a href="#profilelengkap" data-toggle="tab"
                                            class="nav-link active show">Profile Lengkap</a>
                                    </li>
                                    <li class="nav-item"><a href="#changepw" data-toggle="tab" class="nav-link">Ganti
                                            Kata Sandi</a>
                                    </li>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-6 mb-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<?= $dataakun['nama_siswa'] ?>"
                                                            firstName" class="form-control" placeholder="Parsley"
                                                            required readonly>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<?= $dataakun['nis'] ?>" lastName"
                                                ...
                                                <div class="col-lg-6 mb-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            value="<?= namaHariBulanIndonesia($dataakun['tgl_lahir']) ?> "
                                                            class="form-control" id="inputGroupPrepend2"
                                                ...
                                                <div class="col-lg-6 mb-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="phoneNumber" class="form-control"
                                                            value="<?= $dataakun['no_telepon'] ?>" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 mb-3">
                                                    <div class="form-group">
                                                        <label class="text-label">Alamat</label>
                                                        <input type="text" value="<?= $dataakun['alamat'] ?>"
                                                ...
                                                <div class="formeuy">
                                                    <form action="">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control pwold" type="text" name="" id=""
                                                                required>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for=""> Sandi Baru</label>
                                                            <input class="form-control pw1" type="password" name=""
                                                                id="">
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="">Konfirmasi Sandi</label>
                                                            <input class="form-control pw2" type="password" name=""
                                                                id="">
                                                        </div>
                                                        <button class="btn-md btn btn-primary changepass">Ubah
                                                            Sandi</button>
