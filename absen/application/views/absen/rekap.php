            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        $bulan = $_GET['bulan'];
                        ?>
                        <a href="<?= base_url() ?>absen/exportabsen/?kelas=<?= $kelas ?>&jurusan=<?= $jurusan ?>&bulan=<?= $bulan ?>&cariabsen=isset" class="btn btn-primary"> <i class="fas fa-file-export"></i> Download rekapan</a>
