        ...
        <div class="row">
            <div class="img-holder">
                ...
                <div class="info-holder">
                    <img src="<?= base_url('assets/') ?>images/siswa.svg" alt="">
                </div>
            </div>
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        <h3>Daftarkan NIS</h3>
                        <p>Silahkan masukan nomor induk kamu untuk dihubungkan dengan akun siswa</p>
                        <form>
                            <input class="form-control nomorinduk" type="number" name="nomorinduk" placeholder="Nomor induk siswa" required>
                            <div class="info"></div>
                            <div class="form-button full-width">
                                <button id="submit" type="submit" class="ibtn btn-forget">Daftarkan</button>
                            </div>
                        </form>
                    </div>
                    <div class="form-sent">
                        ...
                        <h3>Selamat</h3>
                        <p>NIS Kamu berhasil didaftarkan</p>
                        <div class="info-holder">
                            <span>Untuk mengaktifkan, silakan </span> <a href="#">Hubungi Admin</a>.
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $('.btn-forget').click(function(e) {
        ...
        $('.info').html('<small class="error-message">Nomor induk minimal 5 angka</small>');
        if (inputField.length < 5) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data == 'already') {
                        $('.info').html('<small class="error-message">Nomor induk tersebut salah atau sudah didaftarkan</small>');
