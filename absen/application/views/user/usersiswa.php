                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo base_url('User/editlogsiswa'); ?>">
                        ...
                        <div cl ass="form-group">
                            ...
                            <input type="text" name="nis" class="form-control" placeholder="nis" value="<?php echo $siswa->nis_siswa; ?>" required>
                            <?= form_error('nis', '<small class="text-danger pl-2">', '</small>'); ?>
                        </div>
                        <div class=" form-group">
                            <label>Email</label>
                            <input type="text" name="email" class="form-control input-rounded" placeholder="email" value="<?php echo $siswa->email; ?>">
