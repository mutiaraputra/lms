            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= base_url(); ?>siswa/sinkronisasi" class="btn-sm btn btn-secondary  tambahkelas    shadow"> <i class="flaticon-381-add-2"></i> Sinkronkan</a>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <form action="<?= base_url() ?>siswa/kartusiswa" method="POST">
                                                        <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash() ?>">
                                                        <input type="hidden" name="nis" value="<?= $s['nis'] ?>">
                                                        <input type="hidden" name="nama" value="<?= $s['nama_siswa'] ?>">
