                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="<?= base_url('Auth/Regisration'); ?>" method="POST">
                                        ...
                                        <div class="text-center mt-4">
                                            <button type="submit" class="btn bg-white text-primary btn-block">Buat Akun
                                                </button>
                                        </div>
                                    </form>
                                    <div class="new-account mt-3">
                                        <p class="text-white">Sudah punya akun? <a class="text-white" href="<?= base_url('Auth'); ?>">Masuk</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
