...
class M_absensi extends CI_Model
{
    ...
    public function CariGuru($nik)
    {
        $where = [
            'nik' => $nik
        ];
        return $this->db->where($where)->order_by('nama_guru', 'ASC')
    ...
    public function dataGuru($kelas)
    {
    ...
    public function inputAbsenByGuru($dataguru, $absen, $type)
    {
        $data = [
            'jam_absen' => date('H:i:s'),
            'tanggal_absen' => date('Y-m-d'),
        ...
        $this->db->insert('tabel_detail_absen_guru', $data);
    }
	...
	// Ambil semua jadwal absen guru
	public function get_all_jam_absen()
	{
    $this->db->select('tabel_jam_absen_guru.*, tabel_guru.nama_guru');
    $this->db->from('tabel_jam_absen_guru');
    $this->db->join('tabel_guru', 'tabel_jam_absen_guru.nik = tabel_guru.nik', 'left');
    return $this->db->get()->result();
	}

	// Insert jam absen
	public function insert_jam_absen($data)
	{
		return $this->db->insert('tabel_jam_absen_guru', $data);
	}
	
	public function delete_jam_absen($id)
	{
    return $this->db->delete('tabel_jam_absen_guru', ['id' => $id]);
	}

	public function update_jam_absen($id, $data)
	{
    $this->db->where('id', $id);
    return $this->db->update('tabel_jam_absen_guru', $data);
	}
