...
class Absen extends CI_Controller
{
	...
	{ 			
		...
		// Ambil semua guru
		$data['guru'] = $this->M_absensi->get_all_guru();
		
		// Ambil data jam absen yang sudah ada
		$data['jam_absen'] = $this->M_absensi->get_all_jam_absen();

		
		$this->load->view('templates/header', $data);
		$this->load->view('absen/settingjamguru', $data);
		$this->load->view('templates/footer');
	}

	public function simpan_jam_absen()
	{
		...
		$this->M_absensi->insert_jam_absen($data);
		$this->session->set_flashdata('success', 'Jam absen berhasil ditambahkan.');
		redirect('absen/setting_jam');
	}
	
	public function hapus_jam_absen($id)
	{
		$this->M_absensi->delete_jam_absen($id);
		$this->session->set_flashdata('success', 'Jam absen berhasil dihapus.');
		redirect('absen/setting_jam');
	}
	
	public function update_jam_absen()
	{
    ...
    $this->M_absensi->update_jam_absen($id, $data);
    $this->session->set_flashdata('success', 'Jam absen berhasil diupdate.');
    redirect('absen/setting_jam');
	}
