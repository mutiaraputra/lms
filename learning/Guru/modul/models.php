...
echo '<div class="error">ERROR: Ekstensi file tidak di izinkan!</div>';
  ...
  $nama = time();
    ...
    $sql= mysqli_query($con,"INSERT INTO tb_materi VALUES (NULL,'$_POST[judul]','$_POST[materi]','$nama','text','0','--','$date','$_POST[id_roleguru]','Y',0) ") or die(mysqli_error($con));
      if ($sql) {
		echo "
			<script type='text/javascript'>
			setTimeout(function () {
...
$in = mysqli_query($con,"INSERT INTO tb_materi VALUES (NULL,'$_POST[judul]','$_POST[materi]','$nama','$file_ext','$file_size','$lokasi','$date','$_POST[id_roleguru]','Y',0)");
