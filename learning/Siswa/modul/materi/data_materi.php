...
<!-- Guru --> <b style="color: #00BCD4;">KELAS [ X ] JURUSAN [ TKJ ]</b>
</small>
</h4>
<hr>
                 ...
                 <thead>
                  ...
                  <tbody>
                    ...
                    $sqlmtr = mysqli_query($con,"SELECT * FROM tb_materi
                      ...
                      WHERE tb_roleguru.id_kelas='$data[id_kelas]' AND tb_roleguru.id_jurusan='$data[id_jurusan]' ");
                    ...
                    foreach ($sqlmtr as $row) { ?> 
                      <tr style="border-top: 2px solid black;">
                        ...
                        <td>
                          <a data-toggle="modal" data-target="#<?=$row['id_materi']; ?>" class="btn btn-info btn-rounded btn-fw" style="color: #fff;"> <i class="fa fa-eye"></i>Lihat</a> 
                      ...
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body" style="overflow:scroll;height:450px;">
                            ...
                            $tanggalSekarang = mysqli_real_escape_string($con, $tanggalSekarang);
                            $idmtr = mysqli_real_escape_string($con, $idmtr);
                            $idsiswa = mysqli_real_escape_string($con, $idsiswa);
                            $namasiswa = mysqli_real_escape_string($con, $namasiswa);
                            // Check if record already exists
                            $checkQuery = "SELECT * FROM tb_materibaca WHERE id_siswa = '$idsiswa' AND id_materi = '$idmtr'";
                            $result = mysqli_query($con, $checkQuery);
                            if (mysqli_num_rows($result) == 0) {
                            $sqlbaca = mysqli_query($con, "INSERT INTO tb_materibaca (tgl, id_materi, id_siswa, nama_siswa) 
                               VALUES ('$tanggalSekarang', '$idmtr', '$idsiswa', '$namasiswa')");
                            }
                             ?>
                          </div>
