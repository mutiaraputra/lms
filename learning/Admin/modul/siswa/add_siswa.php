                ...
                <div class="form-group">
                  ...
                  ?>
                   ...
                   <!--      <div class="form-group">
                        ...
                        <button onclick='goBack()' class="btn btn-light">Batal</button>
                      </form>
                    ...
                    if ($pindah) {
                    $save= mysqli_query($con,"INSERT INTO tb_siswa(id_siswa,nis,nama_siswa,jk,password,status,aktif,tingkat,foto,id_kelas,id_jurusan,confirm) VALUES(NULL,'$_POST[nis]','$_POST[nama]','$_POST[jk]','$pass','off','Y','0','$nama_gambar','$_POST[kelas]','$_POST[jurusan]','Yes')");
                    if ($save) {
                    echo " <script>
